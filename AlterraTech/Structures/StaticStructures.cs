...
namespace alterratech.Structures
{
    public static class StaticStructures
    {
        ...
        public static void Register()
        {
            ...
            CoordinatedSpawnsHandler.RegisterCoordinatedSpawn(new SpawnInfo(ServerInfo.TechType, new Vector3(0f, 0f, 30f)));
            CoordinatedSpawnsHandler.RegisterCoordinatedSpawn(new SpawnInfo(ServerInfo.TechType, new Vector3(0f, 0f, 40f)));
            CoordinatedSpawnsHandler.RegisterCoordinatedSpawn(new SpawnInfo(ServerInfo.TechType, new Vector3(0f, 0f, 50f)));
